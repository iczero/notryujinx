...
namespace Ryujinx.Graphics.GAL.Multithreading
{
    public class ThreadedWindow : IWindow
    {
        ...
        public void Present(ITexture texture, ImageCrop crop, Func<object, bool> swapBuffersCallback)
        {
            ...
            _renderer.New<WindowPresentCommand>().Set(new TableRef<ThreadedTexture>(_renderer, texture as ThreadedTexture), crop, new TableRef<Func<object, bool>>(_renderer, swapBuffersCallback));
