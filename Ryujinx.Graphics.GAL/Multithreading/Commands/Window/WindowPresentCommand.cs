...
namespace Ryujinx.Graphics.GAL.Multithreading.Commands.Window
{
    struct WindowPresentCommand : IGALCommand
    {
        ...
        private TableRef<Func<object, bool>> _swapBuffersCallback;

        public void Set(TableRef<ThreadedTexture> texture, ImageCrop crop, TableRef<Func<object, bool>> swapBuffersCallback)
        {
            _texture = texture;
            _crop = crop;
