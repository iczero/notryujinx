...
namespace Ryujinx.Graphics.OpenGL.Effects
{
    internal class FsrUpscaler : IScaler
    {
        ...
        private int _flipXUniform;
        private int _flipYUniform;
        ...
        public void Initialize()
        {
            ...
            _flipXUniform = GL.GetUniformLocation(_scalingShaderProgram, "flipX");
            _flipYUniform = GL.GetUniformLocation(_scalingShaderProgram, "flipY");
            ...
            bool flipY)
        {
            ...
            GL.Uniform1(_flipXUniform, flipX ? 1 : 0);
            GL.Uniform1(_flipYUniform, flipY ? 1 : 0);
