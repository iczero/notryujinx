...
layout( location=10 ) uniform bool flipX;
layout( location=11 ) uniform bool flipY;
layout( location=12 ) uniform float scaleX;
layout( location=13 ) uniform float scaleY;
...
AF2 translateDest(AF2 pos) {
    ...
    translatedPos.y = !flipY ? dstY0 - translatedPos.y : translatedPos.y;
