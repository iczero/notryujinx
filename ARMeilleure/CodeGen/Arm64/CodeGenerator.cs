...
namespace ARMeilleure.CodeGen.Arm64
{
    static class CodeGenerator
    {
        ...
        private static UnwindInfo WritePrologue(CodeGenContext context)
        {
            ...
            int vecMask = CallingConvention.GetVecCalleeSavedRegisters() & context.AllocResult.VecUsedRegisters;
            ...
            int calleeSaveRegionSize = Align16(intCalleeSavedRegsCount * 8) + vecCalleeSavedRegsCount * 16;

            int offset = 0;

            WritePrologueCalleeSavesPreIndexed(context, pushEntries, ref intMask, ref offset, calleeSaveRegionSize, OperandType.I64);

            if ((intCalleeSavedRegsCount & 1) != 0)
            {
                offset += 8;
            }

            WritePrologueCalleeSavesPreIndexed(context, pushEntries, ref vecMask, ref offset, calleeSaveRegionSize, OperandType.V128);
        ...
        private static void WriteEpilogue(CodeGenContext context)
        {
            ...
            int offset = calleeSaveRegionSize;

            WriteEpilogueCalleeSavesPostIndexed(context, ref vecMask, ref offset, calleeSaveRegionSize, OperandType.V128);
        ...
        private static void GenerateConstantCopy(CodeGenContext context, Operand dest, ulong value)
        {
            if (value != 0)
            {
                ...
                context.Assembler.Mov(dest, (ushort)value);
                value >>= 16;
