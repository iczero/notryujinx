    ...
    public class AvaloniaKeyboard : IKeyboard
    {
        ...
        public GamepadStateSnapshot GetMappedStateSnapshot()
        {
            ...
            lock (_userMappingLock)
            {
                ...
                {
                    if (entry.From == Key.Unknown || entry.From == Key.Unbound ||
                        entry.To == GamepadButtonInputId.Unbound)
                    {
                        continue;
                    }
                ...
                result.SetStick(StickInputId.Right, ConvertRawStickValue(rightStickX),
                    ConvertRawStickValue(rightStickY));
            }
